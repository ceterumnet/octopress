...
{% codeblock gamecon_gpio_rpi.c start:60 mark:61%}
...
``` c gamecon_gpio_rpi.c start:333
...
{% img /images/o-scope-screen-command-4us.png %}
...
``` c gamecon_gpio_rpi.c start:149 mark:162,162-162,164-164,167-167,169-169
...
{% img /images/o-scope-screen-command-no-response.png %}
{% img right /images/o-scope-screen-command-response.png %}
...
``` c gamecon_gpio_rpi.c start:173 mark:175
